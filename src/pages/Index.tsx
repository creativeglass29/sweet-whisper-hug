          ...
          <div className="max-w-2xl">
            ...
            <div className="flex flex-wrap gap-4 animate-fade-up" style={{ animationDelay: "0.3s" }}>
              ...
              <a href="tel:+919100911580">
                <Button size="lg" className="rounded-full gap-2 text-base px-8 bg-primary-foreground text-foreground hover:bg-primary-foreground/90">
      ...
      <section className="relative py-20 overflow-hidden">
        ...
        <div className="relative container-main text-center px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4 animate-on-scroll">
            ...
            <a href="tel:+919100911580">
              <Button size="lg" className="rounded-full gap-2 px-8 bg-foreground text-primary-foreground hover:bg-foreground/90">
